...
- **Consolidation health error count (#717).** `BeamMemory.health()` now
  applies the zero-item guard to both error-like summary patterns, avoiding
  false positives from successful summaries that mention `fail`.
